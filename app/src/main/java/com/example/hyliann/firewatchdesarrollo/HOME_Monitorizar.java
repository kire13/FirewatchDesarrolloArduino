    ...
    private void RefreshSectores(RecyclerView lista){
        ...
        switch (lista.getId()){
            ...
            case R.id.rv_humedad:
                sectores=AgregarSectores();
                adapter=new HumedadAdapter(sectores);//Customizar para cada adaptador de cada sensor
                break;
            case R.id.rv_temperatura:
                sectores=AgregarSectores();
                adapter=new TemperaturaAdapter(sectores);//Customizar para cada adaptador de cada sensor
                break;
        }
